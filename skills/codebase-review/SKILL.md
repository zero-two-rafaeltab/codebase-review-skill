...
6. **Inspect before judging.** Use the cartography summary and approved review plan to choose representative paths, then perform bounded manual discovery and record architecture, maintainability, testing, documentation, and risk signals with concrete evidence.
